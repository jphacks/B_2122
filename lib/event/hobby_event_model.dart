...
class HobbyEventModel extends ChangeNotifier {
  final _hobbyEventsCorrection = FirebaseFirestore.instance
      .collection('events')
      .doc('hobby_events')
      .collection('hobby_event_details');

  List<HobbyEvent>? hobbyEvents;

  void fetchHobbyEventList() async {
    final snapshot = await _hobbyEventsCorrection.get();
    final List<HobbyEvent> hobbyEvents =
