...
class CollegeLifeCommunityDetailPage extends StatelessWidget {
  final CollegeLifeCommunity collegeLifeCommunity;
  CollegeLifeCommunityDetailPage(this.collegeLifeCommunity);
