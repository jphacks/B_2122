...
class ClubCommunityDetailPage extends StatelessWidget {
  final ClubCommunity clubCommunity;
  ClubCommunityDetailPage(this.clubCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(clubCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
