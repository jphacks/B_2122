...
class PartTimeCommunityDetailPage extends StatelessWidget {
  final PartTimeCommunity partTimeCommunity;
  PartTimeCommunityDetailPage(this.partTimeCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(partTimeCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
