...
class SportsCommunityDetailPage extends StatelessWidget {
  final SportsCommunity sportsCommunity;
  SportsCommunityDetailPage(this.sportsCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(sportsCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
