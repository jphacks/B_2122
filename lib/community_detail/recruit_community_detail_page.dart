...
class RecruitCommunityDetailPage extends StatelessWidget {
  final RecruitCommunity recruitCommunity;
  RecruitCommunityDetailPage(this.recruitCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(recruitCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
