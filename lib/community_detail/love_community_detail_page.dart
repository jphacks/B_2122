...
class LoveCommunityDetailPage extends StatelessWidget {
  final LoveCommunity loveCommunity;
  LoveCommunityDetailPage(this.loveCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(loveCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
