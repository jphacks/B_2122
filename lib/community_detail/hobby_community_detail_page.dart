...
class HobbyCommunityDetailPage extends StatelessWidget {
  final HobbyCommunity hobbyCommunity;
  HobbyCommunityDetailPage(this.hobbyCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(hobbyCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
