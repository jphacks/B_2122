...
class StudyCommunityDetailPage extends StatelessWidget {
  final StudyCommunity studyCommunity;
  StudyCommunityDetailPage(this.studyCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(studyCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
