...
class LectureCommunityDetailPage extends StatelessWidget {
  final LectureCommunity lectureCommunity;
  LectureCommunityDetailPage(this.lectureCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(lectureCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
