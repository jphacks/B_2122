...
class InternshipCommunityDetailPage extends StatelessWidget {
  final InternshipCommunity internshipCommunity;
  InternshipCommunityDetailPage(this.internshipCommunity);
                  ...
                  Row(children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: SizedBox(
                            child: Center(
                                child: Text(internshipCommunity.contents))),
                      ),
                    ),
                  ]),
                ]),
