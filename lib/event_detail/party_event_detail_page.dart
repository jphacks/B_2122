...
class PartyEventDetailPage extends StatelessWidget {
  final PartyEvent partyEvents;

  PartyEventDetailPage(this.partyEvents);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: partyEventWidget(context, partyEvents),
    );
  }
