...
class FoodEventDetailPage extends StatelessWidget {
  final FoodEvent foodEvents;

  FoodEventDetailPage(this.foodEvents);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: foodEventWidget(context, foodEvents),
    );
  }
