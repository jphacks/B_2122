...
class HobbyEventDetailPage extends StatelessWidget {
  final HobbyEvent hobbyEvents;

  HobbyEventDetailPage(this.hobbyEvents);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: hobbyEventWidget(context, hobbyEvents),
    );
  }
