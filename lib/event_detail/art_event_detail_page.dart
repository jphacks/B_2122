...
class ArtEventDetailPage extends StatelessWidget {
  final ArtEvent artEvents;

  ArtEventDetailPage(this.artEvents);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: artEventWidget(context, artEvents),
    );
  }
